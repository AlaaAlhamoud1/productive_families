...
import 'package:productive_families/presentation/screens/order/screens/order_information.dart';
import 'package:productive_families/presentation/screens/order/widgets/orders_container_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: FutureBuilder(
            future: getOrdersByUserId(getStringAsync("ID")),
